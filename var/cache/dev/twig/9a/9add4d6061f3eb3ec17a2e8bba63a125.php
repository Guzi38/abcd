...
class __TwigTemplate_d7cbd1a9866048a6afcb4486ce4b8688 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    ";
        ...
        if ((array_key_exists("records", $context) && twig_length_filter($this->env, (isset($context["records"]) || array_key_exists("records", $context) ? $context["records"] : (function () { throw new RuntimeError('Variable "records" does not exist.', 9, $this->source); })())))) {
            ...
            $context['_seq'] = twig_ensure_traversable((isset($context["records"]) || array_key_exists("records", $context) ? $context["records"] : (function () { throw new RuntimeError('Variable "records" does not exist.', 22, $this->source); })()));
            foreach ($context['_seq'] as $context["_key"] => $context["record"]) {
                // line 23
                echo "                <tr>
                    <td>";
                // line 24
                echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["record"], "id", [], "any", false, false, false, 24), "html", null, true);
                echo "</td>
                    <td>";
                // line 25
                ...
                echo "</td>
                    <td>";
                // line 26
                echo twig_escape_filter($this->env, twig_join_filter(twig_get_attribute($this->env, $this->source, $context["record"], "tags", [], "any", false, false, false, 26), ", "), "html", null, true);
                echo "</td>
                    <td>&nbsp;</td>
                </tr>
            ";
    ...
    {
        return array (  158 => 34,  155 => 33,  150 => 30,  140 => 26,  136 => 25,  132 => 24,  129 => 23,  125 => 22,  117 => 17,  112 => 15,  108 => 14,  104 => 13,  99 => 10,  97 => 9,  92 => 8,  82 => 7,  69 => 4,  59 => 3,  36 => 1,);
    }
...
{% block body %}
    ...
    {% endif %}
{% endblock  %}", "record/index.html.twig", "C:\\xampp\\htdocs\\szymonprojekt\\app\\templates\\record\\index.html.twig");
    }
}
