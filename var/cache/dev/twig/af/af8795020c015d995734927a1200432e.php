...
class __TwigTemplate_bc528fc7cbaff64bae64e70467612e91 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <h2>";
        // line 9
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans("title.post_create"), "html", null, true);
        echo "</h2>
    ";
        // line 10
...
";
    ...
    {
        return array (  122 => 20,  116 => 17,  112 => 16,  106 => 13,  101 => 11,  97 => 10,  93 => 9,  90 => 8,  80 => 7,  69 => 4,  59 => 3,  36 => 1,);
    }
...
{% block main %}
    ...
    <div class=\"form-group row float-sm-left\">
        <a href=\"{{ url('post_index') }}\" class=\"btn btn-link\">
            {{ 'action.back_to_list'|trans }}
        </a>
    </div>
    {{ form_end(form) }}
{% endblock %}", "post/create.html.twig", "C:\\xampp\\htdocs\\szymonprojekt\\app\\templates\\post\\create.html.twig");
    }
}
